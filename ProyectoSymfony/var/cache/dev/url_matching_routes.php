...
return [
    ...
    [ // $staticRoutes
        ...
        '/listar/libros/biblioteca' => [[['_route' => 'listar_libros_biblioteca', '_controller' => 'App\\Controller\\ListarLibrosBiliotecaController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
