...
class __TwigTemplate_670285e0d227df84b23e8933d314b5d5 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "<h1>Buscar Libro por Editorial y Biblioteca</h1>
    ...
    <ul>
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["libro"]) {
                ...
                yield " por ";
                yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["libro"], "editorial", [], "any", false, false, false, 22), "html", null, true);
                yield " en ";
...
<form method=\"get\" action=\"{{ path('buscar_libro_editorial_biblioteca') }}\">
    <label for=\"editorial\">Editorial:</label>
    <input type=\"text\" id=\"editorial\" name=\"editorial\" required>
...
{% if libros is defined %}
    ...
    <ul>
        {% for libro in libros %}
            <li>{{ libro.titulo }} por {{ libro.editorial }} en {{ libro.biblioteca.nombre }}</li>
        {% else %}
            <li>No hay libros disponibles.</li>
        {% endfor %}
    </ul>
{% endif %}
{% endblock %}", "buscar_libro_editorial_biblioteca/index.html.twig", "/Users/Gonzalo/Desktop/IngenieriaInformatica/CUARTO/SEGUNDO CUATRI/Arquitectura del Software/PracticaFinalSymfony/ProyectoSymfony/templates/buscar_libro_editorial_biblioteca/index.html.twig");
    }
}
