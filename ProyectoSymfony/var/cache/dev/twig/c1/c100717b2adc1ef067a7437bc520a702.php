...
<ul>
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["biblioteca"]) {
            ...
            <form action=\"";
            // line 13
            yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_borrar_biblioteca", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["biblioteca"], "id", [], "any", false, false, false, 13)]), "html", null, true);
            yield "\" method=\"post\">
...
";
    ...
    {
        return array (  113 => 20,  106 => 18,  96 => 13,  92 => 12,  88 => 11,  85 => 10,  80 => 9,  75 => 6,  68 => 5,  54 => 3,  37 => 1,);
    }
...
<ul>
    {% for biblioteca in bibliotecas %}
        <li>
            ...
            <form action=\"{{ path('app_borrar_biblioteca', {'id': biblioteca.id}) }}\" method=\"post\">
                <button type=\"submit\" class=\"btn btn-danger\">Borrar</button>
            </form>
        </li>
    {% else %}
...
", "listar_bibliotecas/index.html.twig", "/Users/administrador/Desktop/github/PracticaFinalSymfony/proyectoSymfony/templates/listar_bibliotecas/index.html.twig");
    }
}
